...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 14, 2019 at 10:38 AM
...
INSERT INTO `publication` (`ID_publication`, `Name`, `Date`, `Note`, `Link`, `Initial_page`, `Page_final`, `Tom`, `Issue_number`, `DOI`, `ISBN`, `ID_city_id`, `ID_employee_id`, `ID_magazine_id`, `ID_status_id`, `ID_type_publication_id`, `ID_year_id`, `File`, `ID_publisher_id`) VALUES
(2, 'ПРОСТРАНСТВЕННЫЕ ОГРАНИЧЕНИЯ ПОЛИТИКИ ЦЕНОВОЙ СТАБИЛЬНОСТИ В РОССИЙСКОЙ ФЕДЕРАЦИИ', '2019-05-08', 'Статья посвящена оценке пространственных ограничений политики ценовой стабильности в России.', 'https://cyberleninka.ru/article/n/prostranstvennye-ogranicheniya-politiki-tsenovoy-stabilnosti-v-rossiyskoy-federatsii', '', '', '', '', '3123212213', '423432432432423', 1, 3, 1, 1, 3, 2, ' ', 1),
(3, 'w', '2019-06-13', '', '', '', '', '', '342', '324', '234', 1, 2, 8, 3, 1, 2, ' ', 1),
(4, '12', '2019-06-13', '', '', '', '', '', '12', '123', '2', 2, 2, 11, 3, 1, 3, ' ', 1),
(5, 'sdf', '2019-06-13', '', '', '', '', '', '2', '432', '2', 2, 2, 11, 3, 1, 3, ' ', 1),
(6, 'dfs', '2019-06-13', '', '', '', '', '', 'dfs', 'dsf', 'sdf', 2, 2, 8, 3, 1, 2, ' ', 1),
(7, 'jkl', '2019-06-13', '', '', '', '', '', 'j', 'jk', 'j', 2, 2, 11, 3, 1, 3, '33ca0d707a0867ad39d253b4b98fb177.jpg', 4);
