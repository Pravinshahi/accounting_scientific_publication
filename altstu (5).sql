...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2019 at 12:28 PM
...
(101, 'Can add source_finance', 26, 'add_source_finance'),
(102, 'Can change source_finance', 26, 'change_source_finance'),
(103, 'Can delete source_finance', 26, 'delete_source_finance'),
(104, 'Can view source_finance', 26, 'view_source_finance');
...
(30, 'publication', '0013_source_finance', '2019-06-15 07:41:15.757274'),
(31, 'publication', '0014_auto_20190615_1456', '2019-06-15 07:56:14.582738');
...
CREATE TABLE `publication` (
  ...
  `ID_source_finance_id` int(11) NOT NULL,
  `State_registration_number` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `publication` (`ID_publication`, `Name`, `Date`, `Note`, `Link`, `Initial_page`, `Page_final`, `Tom`, `Issue_number`, `DOI`, `ISBN`, `ID_city_id`, `ID_employee_id`, `ID_magazine_id`, `ID_status_id`, `ID_type_publication_id`, `ID_year_id`, `File`, `ID_publisher_id`, `ID_benefit_type_id`, `ID_vulture_id`, `ID_type_article_id`, `ID_source_finance_id`, `State_registration_number`) VALUES
(2, 'ПРОСТРАНСТВЕННЫЕ ОГРАНИЧЕНИЯ ПОЛИТИКИ ЦЕНОВОЙ СТАБИЛЬНОСТИ В РОССИЙСКОЙ ФЕДЕРАЦИИ', '2019-05-08', 'Статья посвящена оценке пространственных ограничений политики ценовой стабильности в России.', 'https://cyberleninka.ru/article/n/prostranstvennye-ogranicheniya-politiki-tsenovoy-stabilnosti-v-rossiyskoy-federatsii', '', '', '', '', '3123212213', '423432432432423', 1, 3, 1, 1, 3, 2, ' ', 1, 4, 5, 3, 3, '1'),
(3, 'w', '2019-06-13', '', '', '', '', '', '342', '324', '234', 1, 2, 8, 3, 1, 2, ' ', 1, 4, 5, 3, 3, '1'),
(5, 'sdf', '2019-06-13', '', '', '', '', '', '2', '432', '2', 2, 2, 11, 3, 1, 3, ' ', 1, 4, 5, 3, 3, '1'),
(6, 'dfs', '2019-06-13', '', '', '', '', '', 'dfs', 'dsf', 'sdf', 2, 2, 8, 3, 1, 2, ' ', 1, 4, 5, 3, 3, '1'),
(7, 'jkl', '2019-06-13', '', '', '', '', '', 'j', 'jk', 'j', 2, 2, 11, 3, 1, 3, '33ca0d707a0867ad39d253b4b98fb177.jpg', 4, 4, 5, 3, 3, '1'),
(9, '2345', '2019-06-14', '24', '234', '', '', '', '2', '234', '324', 2, 2, 11, 3, 1, 3, 'altstu.sql', 5, 4, 5, 3, 3, '1'),
(10, 'df', '2019-06-15', '234', '23', '3', '4', '3', '2', '234', '', 3, 2, 4, 3, 3, 2, 'altstu.sql', 5, 4, 5, 2, 3, '1'),
(13, 'фваыfasd', '2019-06-15', 'фаыв', 'фыва', '', '', '', '', '', '', 3, 2, 11, 3, 4, 3, 'altstu (3).sql', 6, 4, 5, 3, 3, 'фыва'),
(14, 'ауцф', '2019-06-15', 'аыфв', '', '', '', '', '', '', '', 3, 2, 11, 3, 4, 4, 'altstu (3).sql', 6, 4, 5, 3, 3, 'авыф'),
(15, 'fsda234', '2019-06-06', 'afs', '', '', '', '', '', '', '', 3, 2, 11, 3, 5, 4, 'altstu (2).sql', 6, 4, 5, 3, 3, 'fdsa'),
(17, 'asdfasdf234', '2019-06-15', 'asdf', 'adsf', '', '', '', '23', 'sadf', 'dsfa', 3, 2, 11, 3, 1, 4, 'altstu (3).sql', 6, 4, 5, 3, 3, ''),
(18, 'asdf', '2019-06-15', 'afsd', 'asfd', '', '', '', 'safd', 'sadf', 'afsd', 2, 2, 11, 3, 2, 2, 'altstu (2).sql', 4, 3, 3, 3, 3, ''),
(19, 'fdsa', '2019-06-15', 'afsd', '324', '43', '3', '34', '3', 'afsd', '', 3, 2, 3, 3, 3, 2, 'altstu (3).sql', 4, 4, 5, 2, 3, ''),
(20, 'fdsa', '2019-06-15', 'fsad', 'fsad', '', '', '', '', '', '', 3, 2, 11, 3, 4, 3, 'altstu (2).sql', 6, 4, 5, 3, 2, 'fsda');
...
--
-- Table structure for table `source_finance`
--

CREATE TABLE `source_finance` (
  `ID_source_finance` int(11) NOT NULL,
  `Name` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `source_finance`
--

INSERT INTO `source_finance` (`ID_source_finance`, `Name`) VALUES
(1, 'Министерство образования'),
(2, 'Российский фонд фундаментальный исследования'),
(3, 'Отсутствует');
...
ALTER TABLE `publication`
  ...
  ADD KEY `publication_ID_source_finance_id_844d5031_fk_source_fi` (`ID_source_finance_id`);
...
--
-- Indexes for table `source_finance`
--
ALTER TABLE `source_finance`
  ADD PRIMARY KEY (`ID_source_finance`);
...
--
ALTER TABLE `publication`
  MODIFY `ID_publication` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
-- AUTO_INCREMENT for table `source_finance`
--
ALTER TABLE `source_finance`
  MODIFY `ID_source_finance` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `type_publication`
  MODIFY `ID_type_publication` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
ALTER TABLE `publication`
  ...
  ADD CONSTRAINT `publication_ID_source_finance_id_844d5031_fk_source_fi` FOREIGN KEY (`ID_source_finance_id`) REFERENCES `source_finance` (`ID_source_finance`),
